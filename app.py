...
#         abort(400, "Missing or invalid 'problem_statement'; expected a non-empty string.")
...
#         "  • content: a self-contained, 2–3 minute read (about 500–600 words) that elaborates on the concept "
#         "  • example: a 1–2 sentence, concrete scenario showing how it applies in general terms\n"
#         "in the context of the problem—enough to learn the topic deeply, but **do not** give away the full solution.\n"
#         "Keep each entry focused and structured like a mini-lesson or guided hint.\n"
#         "Return **only** the JSON.\n\n"
#         "Problem Statement:\n\"\"\"\n"
#         f"{problem}\n"
#         "\"\"\"\n"
...
#         return jsonify({"pills": parsed.get("pills", [])})
#     except json.JSONDecodeError:
#         return jsonify({"error": "Invalid JSON from model", "raw": resp.choices[0].message.content}), 502
#     except Exception as e:
...
def generate_pills():
    ...
    if use_problem_context and problem and isinstance(problem, str):
        ...
        #     "Provide enough depth to learn the topic thoroughly, but **do not** reveal the complete solution to the problem.\n"
        #     "Return **only** the JSON.\n\n"
        #     f"Problem Statement:\n\"\"\"\n{problem}\n\"\"\"\n"
        #     "Topics: " + ", ".join(topics)
        # )
